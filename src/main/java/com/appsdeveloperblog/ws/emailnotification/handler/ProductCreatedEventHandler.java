...
import com.appsdeveloperblog.ws.emailnotification.io.ProcessedEventsRepository;
...
public class ProductCreatedEventHandler {
	...
	public ProductCreatedEventHandler(RestTemplate restTemplate,  ProcessedEventsRepository processedEventsRepository) {
	...
	public void handle(@Payload ProductCreatedEvent productCreatedEvent, @Header("messageId") String messageId,
        ...
        ProcessedEventEntity event = processedEventsRepository.findByMessageId(messageId);
        if (event != null) {
            LOGGER.info("Event already exists: " + event.getMessageId());
            return;
        }
